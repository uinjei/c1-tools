(function () {
  ...
  try {
    self$5.WeakMap = WeakMap;
  } catch (WeakMap) {
    // this could be better but 90% of the time
    // it's everything developers need as fallback
    self$5.WeakMap = function (id, Object) {
  ...
  try {
    self$4.Event = new Event('.').constructor;
  } catch (Event) {
    try {
      self$4.Event = new CustomEvent('.').constructor;
    } catch (Event) {
      self$4.Event = function Event(type, init) {
        if (!init) init = {};
  ...
  var createRender = function createRender(Tagger) {
    return {
      ...
      render: function render(where, what) {
        ...
        var wire = hole instanceof LighterHole ? unroll$1(Tagger, info, hole) : hole;
  ...
  var outer = function outer(type, Tagger) {
    ...
    var fixed = function fixed(info) {
      return function () {
        return unroll$1(Tagger, info, hole.apply(null, arguments));
      };
    };

    hole["for"] = function (ref, id) {
      var memo = cache.get(ref) || cache.set(ref, create$2(null));
      return memo[id] || (memo[id] = fixed(createCache$1()));
    };

    hole.node = function () {
      return unroll$1(Tagger, createCache$1(), hole.apply(null, arguments)).valueOf();
    };
  ...
  var unroll$1 = function unroll(Tagger, info, _ref) {
    var _entry;
    ...
    unrollValues$1(Tagger, info, values, length);
  ...
  var unrollValues$1 = function unrollValues(Tagger, _ref2, values, length) {
    var stack = _ref2.stack;

    for (var i = 0; i < length; i++) {
      var hole = values[i];
      if (hole instanceof Hole) values[i] = unroll$1(Tagger, stack[i] || (stack[i] = createCache$1()), hole);else if (isArray(hole)) unrollValues(Tagger, stack[i] || (stack[i] = createCache$1()), hole, hole.length);else stack[i] = null;
    }
  ...
  var _createRender = createRender(Tagger),
      render$2 = _createRender.render,
      html$1 = _createRender.html,
      svg$1 = _createRender.svg;
  ...
  var augmentor$1 = function augmentor(fn) {
    var stack = [];
    ...
    if ('render' in prototype && prototype.render.length) {
      ...
      defineProperties$1(prototype, {
        oninit: {
          configurable: configurable,
          value: function value() {
            var hook = augmentor$1(this.render.bind(this, hooks));
  ...
  */
  ...
  var render = function render(where, what) {
    ...
    var info = cache.get(where) || cache.set(where, createCache(null));
    info.w = where;
    info.W = what;
    return render$2(where, hook instanceof Hook ? unroll(info, hook) : (unrollHole(info, hook), hook));
  };
  var update = false;

  var updateEntry = function updateEntry(entry, node) {
    if (node !== entry.node) {
      if (entry.node) update = true;
      entry.node = node;
    }
  };
  ...
  var createCache = function createCache(p) {
    return {
      p: p,
      stack: [],
      entry: null
  ...
  var unrollValues = function unrollValues(info, values, length) {
    var stack = info.stack;

    for (var i = 0; i < length; i++) {
      var hook = values[i];
      if (hook instanceof Hook) values[i] = unroll(stack[i] || (stack[i] = createCache(info)), hook);else if (hook instanceof Hole) unrollHole(stack[i] || (stack[i] = createCache(info)), hook);else if (isArray(hook)) unrollValues(stack[i] || (stack[i] = createCache(info)), hook, hook.length);else stack[i] = null;
    }
  ...
  var view = function view(entry, _ref3) {
    var type = _ref3.type,
        ...
        values = _ref3.values;
    return (type === 'svg' ? svg$1 : html$1)["for"](entry, type).apply(void 0, [template].concat(_toConsumableArray(values)));
  };
  ...
  function createFor(lighter) {
    ...
    return function (entry, id) {
      var store = cache.get(entry) || cache.set(entry, create(null));
      var info = store[id] || (store[id] = createCache(null));
      return function (template) {
  ...
  var Tag = {
    onconnected: function onconnected() {
      ...
      tagify = new Tagify(tagInput, {
        ...
        callbacks: {
          add: function add() {
            return _this.data.handleAdd(tagify);
          },
          // callback when adding a tag
          remove: function remove() {
            return _this.data.handleRemove(tagify);
  ...
  var Util = /*#__PURE__*/_createClass(function Util() {
    ...
    _defineProperty(this, "readJSONFile", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(__filename) {
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Neutralino.filesystem.readFile(__filename, {
                  encoding: "utf8"
                }).then(toJSON);
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this.readJSONFile('./settings.json');
    ...
    _defineProperty(this, "writeToJSONFile", function (_ref3) {
      ...
      Neutralino.filesystem.writeFile("".concat(_this.settings.outputFolder, "/").concat(name, "_").concat(currency, "_").concat(timing, "_").concat(proration, ".json"), JSON.stringify(payload, null, _this.settings.prettify ? 4 : 0));
    });
  ...
  var Build = /*#__PURE__*/_createClass(function Build() {
    ...
    _defineProperty(this, "selectValueFromProductOfferDefinedProductSpecCharValues", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(productOfferId) {
        var characteristic, __filename, _yield$util$readJSONF, prodSpecCharValueUse, productSpecification, productOfferingTerm, localizedName, place;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return util$2.readJSONFile(__filename);

              case 4:
                _yield$util$readJSONF = _context.sent;
                prodSpecCharValueUse = _yield$util$readJSONF.prodSpecCharValueUse;
                productSpecification = _yield$util$readJSONF.productSpecification;
                productOfferingTerm = _yield$util$readJSONF.productOfferingTerm;
                localizedName = _yield$util$readJSONF.localizedName;
  ...
  var Main = /*#__PURE__*/_createClass(function Main() {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return Promise.all(spoPrice.map(function (price) {
                  ...
                  return util$1.readJSONFile(__filename).then(function (_ref2) {
    ...
    _defineProperty(this, "findMainSpoPrice", function (args) {
      ...
      return util$1.readJSONFile(__filename).then(function (_ref3) {
    ...
    _defineProperty(this, "getGeneratedPayloadList", function () {
      return util$1.settings.bpoIds.map(function (id) {
        ...
        return util$1.readJSONFile(__filename).then(_this.buildPayload).then(_this.findMainSpoPrice).then(_this.findPrice).then(util$1.writeToJSONFile)["catch"](function (error) {
          return error;
        });
      });
    });
    ...
    _defineProperty(this, "generate", function () {
      util$1 = new Util();
      build = new Build();
      util$1.getSettings().then(function (setting) {
        Promise.all(_this.getGeneratedPayloadList()).then(function (errors) {
          var errorJSON = {};
          var errorCount = errors.filter(function (error) {
            return error;
          }).length;
          console.log("Successfully generated ".concat(errors.length - errorCount, " payloads"));

          if (errorCount > 0) {
            console.log("Error found in ".concat(errorCount, " file(s)"));
            ...
            Neutralino.filesystem.writeFile("".concat(util$1.settings.outputFolder, "/error-").concat(Date.now(), ".json"), JSON.stringify(errorJSON));
          }
  ...
  var _saveSettings = function _saveSettings(data) {
    ...
    var bpoIds = data.bpoIds.value.map(function (prop) {
      return prop.value;
    });
    settingsData.bpoIds = bpoIds;
    Neutralino.filesystem.writeFile("./settings.json", JSON.stringify(settingsData, null, 4)).then(function (data) {
      console.log(data);
    });
  };

  var _handleRemove = function _handleRemove(tagify) {
    console.log(tagify); //contents.find(content => LOCALE === content.locale).value;
  };
    ...
    onconnected: function onconnected() {
      ...
      util.getSettings().then(function (setting) {
        _this.data = {
          ...
          bpoIds: {
            label: "BPO IDs",
            value: setting.bpoIds.map(function (id) {
              return {
                value: id
              };
            })
    ...
    render: function render(_ref) {
      ...
      this.html(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n    <div class=\"container\">\n      <div class=\"content\">\n          <h3>Payload Generator</h3>\n          <div class=\"field\">\n            <File data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Tag data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <File data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Checkbox data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Checkbox data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Checkbox data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Checkbox data=\"", "\"/>\n          </div>\n          <div class=\"field\">\n            <Textfield data=\"", "\"/>\n          </div>\n          <button class=\"button\" onclick=\"", "\">Generate</button>\n      </div>\n    </div>\n    "])), _objectSpread(_objectSpread({}, this.data.fdLocation), {}, {
        ...
        handleInput: function handleInput(e) {
          ...
          var dir = "".concat(_this2.data.fdLocation.value, "\\").concat(PRODUCT_OFFERING_FOLDER);
          Neutralino.filesystem.readDirectory(dir).then(function (entries) {
            ...
            var bpoIds = entries.map(function (entry) {
              var jsonPath = "".concat(_this2.data.fdLocation.value, "\\").concat(PRODUCT_OFFERING_FOLDER, "\\").concat(entry.entry);
        ...
        handleAdd: function handleAdd(tagify) {
          _this2.data.bpoIds = _objectSpread(_objectSpread({}, _this2.bpoIds), {}, {
            value: tagify.value
          });

          _saveSettings(_this2.data);
        },
        handleRemove: function handleRemove(tagify) {
          return _handleRemove(_this2.data.bpoIds);
        }
      }), _objectSpread(_objectSpread({}, this.data.outputFolder), {}, {
        handleClick: function handleClick() {
          Neutralino.os.showFolderDialog('Select Directory').then(function (directory) {
            if (directory !== "") {
              _this2.data.outputFolder = _objectSpread(_objectSpread({}, _this2.data.outputFolder), {}, {
                value: directory
              });
              update({});
            }
      ...
      }), _objectSpread(_objectSpread({}, this.data.prettify), {}, {
        handleChange: function handleChange(e) {
          _this2.data.prettify = _objectSpread(_objectSpread({}, _this2.data.prettify), {}, {
            value: e.target.checked
          });

          _saveSettings(_this2.data);
        }
      }), _objectSpread(_objectSpread({}, this.data.allowRandomQty), {}, {
        handleChange: function handleChange(e) {
          _this2.data.allowRandomQty = _objectSpread(_objectSpread({}, _this2.data.allowRandomQty), {}, {
            value: e.target.checked
          });

          _saveSettings(_this2.data);
        }
      }), _objectSpread(_objectSpread({}, this.data.includeAllSpo), {}, {
        handleChange: function handleChange(e) {
          _this2.data.includeAllSpo = _objectSpread(_objectSpread({}, _this2.data.includeAllSpo), {}, {
            value: e.target.checked
          });

          _saveSettings(_this2.data);
        }
      }), _objectSpread(_objectSpread({}, this.data.offNet3rdPartyProvider), {}, {
        handleChange: function handleChange(e) {
          _this2.data.offNet3rdPartyProvider = _objectSpread(_objectSpread({}, _this2.data.offNet3rdPartyProvider), {}, {
            value: e.target.checked
          });

          _saveSettings(_this2.data);
        }
      }), _objectSpread(_objectSpread({}, this.data.productOffersWithPlace), {}, {
        handleChange: function handleChange(e) {
          _this2.data.productOffersWithPlace = _objectSpread(_objectSpread({}, _this2.data.productOffersWithPlace.toString()), {}, {
  ...
  define('App', App);
  render$1(document.body, html(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<App id=\"app\"/>"]))));
